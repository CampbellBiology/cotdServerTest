...
public class RecipeEditController {
    ...
    @PostMapping("/edit")
    public int uploadImage(HttpServletRequest _rq,
        ...
        String jwtStateFlag = _rq.getAttribute("jwtStateFlag").toString();

        if(jwtStateFlag == null|| jwtStateFlag.equals("-1")){
            result = 99;
            System.out.println("토크에러");
            return result;
        }else{

            String writer = _rq.getAttribute("userId").toString();
